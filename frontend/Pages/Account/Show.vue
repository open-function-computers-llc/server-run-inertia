    ...
    <div class="d-flex justify-content-between">
        <div>
            ...
            <div class="d-flex align-items-center">
                ...
                <button v-if="isLocked && !runUnlock" @click="runUnlock = true" class="btn btn-success h-100 d-flex align-items-center">
                    <Lock /><span class="ms-2"> Unlock</span>
                </button>
                <button v-if="isLocked && runUnlock" class="btn btn-success h-100 d-flex align-items-center" disabled>
                    <Lock /><span class="ms-2"> Unlock</span>
                </button>
                <button v-if="!isLocked && !runLock" @click="runLock = true" class="btn btn-danger h-100 d-flex align-items-center">
                    <UnLock /><span class="ms-2"> Lock</span>
                </button>
                <button v-if="!isLocked && runLock" class="btn btn-danger h-100 d-flex align-items-center" disabled>
                    <UnLock /><span class="ms-2"> Lock</span>
                </button>
